...
Blockly.Arduino.grove_ultrasonic_ranger = function() {
  var dropdown_triger_pin  = this.getFieldValue('CONNECTOR');
  var dropdown_dist_pin =  parseInt(dropdown_triger_pin) + 1;
  Blockly.Arduino.includes_['define_ultrasonic'] = '#include <Ultrasonic.h>\n';
  Blockly.Arduino.definitions_['var_ultrasonic'+dropdown_triger_pin] = 'Ultrasonic ultrasonic_'+dropdown_triger_pin+'('+dropdown_triger_pin+','+dropdown_dist_pin+');\n';
   
  var code;
  code = 'ultrasonic_'+dropdown_triger_pin+'.convert(ultrasonic_'+dropdown_triger_pin+'.timing(),Ultrasonic::CM)'; 
...
Blockly.Arduino.grove_line_finder = function() {
  var dropdown_pin = this.getFieldValue('CONNECTOR');
