...
Blockly.Blocks['grove_ultrasonic_ranger'] = {
    ...
    this.appendDummyInput()
	    .appendField(new Blockly.FieldImage( '/blocks/grove/img/ultra_som.jpg', 32, 32))
	    .appendField(Blockly.Msg.GROVE_INOUT_ULTRASONIC_TEXT)
        .appendField(Blockly.Msg.GROVE_INOUT_ULTRASONIC_INPUT)
        //.appendField(new Blockly.FieldTextInput('',  Blockly.Arduino.pinDigitalValidator), 'CONNECTOR')
...
Blockly.Blocks['grove_line_finder'] = {
  init: function() {
    ...
    this.appendDummyInput()
	    .appendField(new Blockly.FieldImage(
            '/blocks/grove/img/line.png', 32, 32))
